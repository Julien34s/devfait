...
AddEventHandler('esx_drugs:hasEnteredMarker', function(zone)
	if myJob == 'cardealer' or myJob == 'sheriff' then
		return
	end
...
AddEventHandler('esx_drugs:ReturnInventory', function(cokeNbr, cokepNbr, methNbr, methpNbr, weedNbr, weedpNbr, crackNbr, crackpNbr, ketamineNbr, ketaminepNbr, ecstasyNbr, ecstasypNbr, opiumNbr, opiumpNbr, jobName, currentZone)
	cokeQTE	      = cokeNbr
