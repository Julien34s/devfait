...
local function TransformCoke(source)
	...
	if CopsConnected < Config.RequiredCopsTCoke then
		TriggerClientEvent('esx:showNotification', source, _U('act_imp_police', CopsConnected, Config.RequiredCopsCoke))
		return
	end
		...
		if PlayersSellingCoke[source] == true then
			...
			if poochQuantity == 0 then
				...
				if CopsConnected == 0 then
					xPlayer.addInventoryItem('argentsale', 305)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_coke'))
				elseif CopsConnected == 1 then
					xPlayer.addInventoryItem('argentsale', 315)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_coke'))
				elseif CopsConnected == 2 then
					xPlayer.addInventoryItem('argentsale', 325)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_coke'))
				elseif CopsConnected == 3 then
					xPlayer.addInventoryItem('argentsale', 335)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_coke'))
				elseif CopsConnected == 4 then
					xPlayer.addInventoryItem('argentsale', 345)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_coke'))
				elseif CopsConnected >= 5 then
					xPlayer.addInventoryItem('argentsale', 355)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_coke'))
				end
	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingCrack[source] == true then
			...
			if poochQuantity == 0 then
				...
				if CopsConnected == 0 then
					xPlayer.addInventoryItem('argentsale', 200)
	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingMeth[source] == true then
			...
			if poochQuantity == 0 then
				...
				if CopsConnected == 0 then
					xPlayer.addInventoryItem('argentsale', 240)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
				elseif CopsConnected == 1 then
					xPlayer.addInventoryItem('argentsale', 250)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
				elseif CopsConnected == 2 then
					xPlayer.addInventoryItem('argentsale', 260)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
				elseif CopsConnected == 3 then
					xPlayer.addInventoryItem('argentsale', 270)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
				elseif CopsConnected == 4 then
					xPlayer.addInventoryItem('argentsale', 280)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
				elseif CopsConnected == 5 then
					xPlayer.addInventoryItem('argentsale', 290)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
				elseif CopsConnected >= 6 then
					xPlayer.addInventoryItem('argentsale', 300)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_meth'))
				end
...
local function TransformKetamine(source)
	...
	SetTimeout(Config.TimeToProcess, function()
		...
		if PlayersTransformingKetamine[source] == true then
			...
			if poochQuantity > 35 then
				TriggerClientEvent('x:showNotification', source, _U('too_many_pouches'))
	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingKetamine[source] == true then
			...
			if poochQuantity == 0 then
				...
				if CopsConnected == 0 then
					xPlayer.addInventoryItem('argentsale', 4250)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ketamine'))
				elseif CopsConnected == 1 then
					xPlayer.addInventoryItem('argentsale', 4400)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ketamine'))
				elseif CopsConnected == 2 then
					xPlayer.addInventoryItem('argentsale', 4550)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ketamine'))
				elseif CopsConnected == 3 then
					xPlayer.addInventoryItem('argentsale', 4700)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ketamine'))
				elseif CopsConnected == 4 then
					xPlayer.addInventoryItem('argentsale', 4850)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ketamine'))
				elseif CopsConnected == 5 then
					xPlayer.addInventoryItem('argentsale', 5000)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ketamine'))
				elseif CopsConnected >= 6 then
					xPlayer.addInventoryItem('argentsale', 5150)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ketamine'))
				end
	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingWeed[source] == true then
			...
			if poochQuantity == 0 then
				...
				if CopsConnected == 0 then
					xPlayer.addInventoryItem('argentsale', 75)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_weed'))
				elseif CopsConnected == 1 then
					xPlayer.addInventoryItem('argentsale', 85)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_weed'))
				elseif CopsConnected == 2 then
					xPlayer.addInventoryItem('argentsale', 95)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_weed'))
				elseif CopsConnected == 3 then
					xPlayer.addInventoryItem('argentsale', 105)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_weed'))
				elseif CopsConnected >= 4 then
					xPlayer.addInventoryItem('argentsale', 115)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_weed'))
				end
	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingEcstasy[source] == true then
			...
			if poochQuantity == 0 then
				...
				if CopsConnected == 0 then
					xPlayer.addInventoryItem('argentsale', 365)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ecstasy'))
				elseif CopsConnected == 1 then
					xPlayer.addInventoryItem('argentsale', 375)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ecstasy'))
				elseif CopsConnected == 2 then
					xPlayer.addInventoryItem('argentsale', 385)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ecstasy'))
				elseif CopsConnected == 3 then
					xPlayer.addInventoryItem('argentsale', 395)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ecstasy'))
				elseif CopsConnected >= 4 then
					xPlayer.addInventoryItem('argentsale', 405)
					TriggerClientEvent('esx:showNotification', source, _U('sold_one_ecstasy'))
				end
