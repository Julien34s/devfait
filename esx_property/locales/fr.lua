Locales['fr'] = {
  ...
  ['buy'] = 'Acheter une propriété pour <span style="color:green;">$%s</span>',
  ['buy2'] = 'Propriété pour <span style="color:red;">$%s</span>',
  ['buy_for'] = 'vous avez acheté une propriété pour ~g~$%s~s~',
  ['rent'] = 'Louer un bien pour <span style="color:green;">$%s</span> / week',
