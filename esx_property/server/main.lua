...
RegisterNetEvent('esx_property:buy2Property')
AddEventHandler('esx_property:buy2Property',function(test)
	TriggerClientEvent('esx:showNotification', source, '~o~ Allez voir le vendeur de  ~b~ maison .' )
end)
